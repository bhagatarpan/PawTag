    ...
    components: {
      ...
      schemas: {
        ...
        Pet: {
          ...
          properties: {
            _id: { type: 'string' },
            petId: { type: 'string', description: 'Auto-generated pet ID: XX-6digits+gender+breed+color (e.g. BU-482731MLB)' },
            ownerId: { type: 'string' },
            name: { type: 'string' },
            ...
            dateOfBirth: { type: 'string', format: 'date', description: 'Pet date of birth' },
            age: { type: 'number', description: 'Auto-computed from dateOfBirth (in years)' },
            favouriteFood: { type: 'string', description: 'Pet favourite food' },
            color: { type: 'string' },
