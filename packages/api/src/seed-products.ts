...
const products = [
  ...
  // --- Subscription Plans ---
  {
    name: 'PawTag Annual Subscription',
    description: 'Annual subscription plan for PawTag. Includes 12 months free with purchase, then $0.99/month billed yearly ($11.88/year). Auto-renew enabled. Cancel anytime — continues until end of billing period.',
    shortDescription: 'Annual plan — $0.99/mo billed yearly',
    price: 0.99,
    currency: 'NZD',
    images: [],
    category: 'Subscriptions',
    tags: ['subscription', 'annual', 'plan'],
    isActive: true,
    stock: 9999,
    sku: 'PT-SUB-ANNUAL',
    variants: [],
    ...
    subscriptionConfig: {
      ...
      freePeriodMonths: 12,
      gracePeriodWeeks: 4,
      features: ['qr_scan', 'nfc_scan', 'lost_pet_alerts', 'finder_notifications'],
    },
  },
  {
    name: 'PawTag Monthly Subscription',
    description: 'Monthly subscription plan for PawTag. Includes 12 months free with purchase, then $1.99/month billed monthly. Auto-renew enabled. Cancel anytime — continues until end of billing period.',
    shortDescription: 'Monthly plan — $1.99/mo',
    price: 1.99,
    currency: 'NZD',
    images: [],
    category: 'Subscriptions',
    tags: ['subscription', 'monthly', 'plan'],
    isActive: true,
    stock: 9999,
    sku: 'PT-SUB-MONTHLY',
    variants: [],
