  ...
  try {
    await session.withTransaction(async () => {
      ...
      const settings: Array<{ key: string; value: string; displayValue?: string; category: string; description?: string }> = [
        ...
        { key: 'addressAutocomplete.nzpostApiKey', value: '', displayValue: 'NZ Post API Key', category: 'addressAutocomplete', description: 'API key for NZ Post Addressing API (get from nzpost.co.nz/business/ecommerce/developer-resource-centre)' },
