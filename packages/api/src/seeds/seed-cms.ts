  ...
  try {
    await session.withTransaction(async () => {
      ...
      const settings: Array<{ key: string; value: string; displayValue?: string; category: string; description?: string }> = [
        ...
        { key: 'site.testMode', value: 'true', displayValue: 'Test Mode', category: 'site', description: 'Route ALL emails to test email in dev mode. When enabled, no emails go to real recipients.' },
        { key: 'site.testEmail', value: 'arpanbhagat@yahoo.com', displayValue: 'Test Email', category: 'site', description: 'Email address that receives ALL emails when test mode is enabled' },
...
<p>If you have questions about these Terms, please contact us at support@pawtag.co.nz.</p>`,
      ...
      const emailTemplates = [
        ...
        // ─── Guardian & Loyalty (missing from DB) ───
        {
...
The PawTag Team`,
        ...
        {
          name: 'Tier Upgrade',
          slug: 'guardian-tier-upgrade',
          subject: 'Congratulations! You\'ve been promoted to {{newTier}} — PawTag',
          title: 'Tier Upgrade!',
          subtitle: 'New Guardian benefits unlocked',
          body: 'Hi {{customerName}},\n\nCongratulations! You\'ve been promoted from {{previousTier}} to {{newTier}}!\n\nYou now have {{points}} points.\n\nNew benefits:\n{{#benefits}}- {{benefits}}\n{{/benefits}}',
          ctaText: 'View Dashboard',
          ctaUrl: '{{dashboardUrl}}',
          senderEmail: 'no-reply@pawtag.co.nz',
          senderName: 'PawTag',
          variables: ['customerName', 'previousTier', 'newTier', 'points', 'benefits', 'dashboardUrl', 'isGoldMember'],
          status: 'active' as const,
          businessFlow: 'guardian_loyalty' as const,
          purpose: 'Celebrates Guardian tier promotion and lists new benefits.',
          triggerDescription: 'Sent when Guardian tier changes.',
          recipientDescription: 'Customer whose tier was upgraded',
          emailType: 'transactional' as const,
          isCritical: false,
          version: 1,
          variableDefinitions: [
            { key: 'customerName', label: 'Customer Name', description: 'First name of the customer', type: 'string', example: 'John', required: true, source: 'Customer' },
            { key: 'previousTier', label: 'Previous Tier', description: 'Previous Guardian tier', type: 'string', example: 'Care', required: true, source: 'Guardian' },
            { key: 'newTier', label: 'New Tier', description: 'New Guardian tier', type: 'string', example: 'Nurture', required: true, source: 'Guardian' },
            { key: 'points', label: 'Points', description: 'Current points balance', type: 'number', example: '250', required: true, source: 'Guardian' },
            { key: 'benefits', label: 'Benefits', description: 'New tier benefits list', type: 'array', example: '2x points, Priority support', required: true, source: 'Guardian' },
            { key: 'dashboardUrl', label: 'Dashboard URL', description: 'Link to Guardian dashboard', type: 'string', example: 'https://pawtag.co.nz/account/guardian', required: true, source: 'System' },
            { key: 'isGoldMember', label: 'Is Gold Member', description: 'Whether customer is a Gold member', type: 'boolean', example: 'false', required: false, source: 'Customer' },
          ],
        },
        {
          name: 'Monthly Summary',
          slug: 'guardian-monthly-summary',
          subject: 'Your {{tier}} Guardian Monthly Summary — PawTag',
          title: 'Monthly Summary',
          subtitle: 'Your Guardian activity this month',
          body: 'Hi {{customerName}},\n\nHere\'s your {{tier}} Guardian monthly summary:\n\nPoints earned: {{pointsEarned}}\nTotal points: {{totalPoints}}\nPawRewards balance: ${{pawRewardsBalance}}\n\n{{#topActivity}}Top activity: {{topActivity}}{{/topActivity}}',
          ctaText: 'View Dashboard',
          ctaUrl: '{{dashboardUrl}}',
          senderEmail: 'no-reply@pawtag.co.nz',
          senderName: 'PawTag',
          variables: ['customerName', 'tier', 'pointsEarned', 'totalPoints', 'pawRewardsBalance', 'pawRewardsAllocated', 'topActivity', 'dashboardUrl'],
          status: 'active' as const,
          businessFlow: 'guardian_loyalty' as const,
          purpose: 'Monthly activity report for Guardian members.',
          triggerDescription: 'Sent monthly via scheduled job.',
          recipientDescription: 'Active Guardian member',
          emailType: 'transactional' as const,
          isCritical: false,
          version: 1,
          variableDefinitions: [
            { key: 'customerName', label: 'Customer Name', description: 'First name of the customer', type: 'string', example: 'John', required: true, source: 'Customer' },
            { key: 'tier', label: 'Tier', description: 'Current Guardian tier', type: 'string', example: 'Nurture', required: true, source: 'Guardian' },
            { key: 'pointsEarned', label: 'Points Earned', description: 'Points earned this month', type: 'number', example: '150', required: true, source: 'Guardian' },
            { key: 'totalPoints', label: 'Total Points', description: 'Total points balance', type: 'number', example: '500', required: true, source: 'Guardian' },
            { key: 'pawRewardsBalance', label: 'PawRewards Balance', description: 'Current PawRewards balance', type: 'number', example: '25.50', required: true, source: 'Guardian' },
            { key: 'topActivity', label: 'Top Activity', description: 'Top earning activity', type: 'string', example: 'Purchase', required: false, source: 'Guardian' },
            { key: 'dashboardUrl', label: 'Dashboard URL', description: 'Link to Guardian dashboard', type: 'string', example: 'https://pawtag.co.nz/account/guardian', required: true, source: 'System' },
          ],
        },
        {
          name: 'PawRewards Reminder',
          slug: 'guardian-pawrewards-reminder',
          subject: 'PawRewards Expiring Soon — PawTag',
          title: 'PawRewards Expiring',
          subtitle: 'Use your rewards before they expire',
          body: 'Hi {{customerName}},\n\nYou have PawRewards that will expire soon:\n\nBalance: ${{balance}}\nExpiring: ${{expirationAmount}} on {{expirationDate}}\n\nRedeem your rewards before they expire!',
          ctaText: 'Redeem Rewards',
          ctaUrl: '{{redeemUrl}}',
          senderEmail: 'no-reply@pawtag.co.nz',
          senderName: 'PawTag',
          variables: ['customerName', 'balance', 'expirationDate', 'expirationAmount', 'redeemUrl'],
          status: 'active' as const,
          businessFlow: 'guardian_loyalty' as const,
          purpose: 'Reminds customer about expiring PawRewards.',
          triggerDescription: 'Sent when PawRewards are approaching expiration.',
          recipientDescription: 'Customer with expiring PawRewards',
          emailType: 'transactional' as const,
          isCritical: false,
          version: 1,
          variableDefinitions: [
            { key: 'customerName', label: 'Customer Name', description: 'First name of the customer', type: 'string', example: 'John', required: true, source: 'Customer' },
            { key: 'balance', label: 'Balance', description: 'Current PawRewards balance', type: 'number', example: '25.50', required: true, source: 'Guardian' },
            { key: 'expirationDate', label: 'Expiration Date', description: 'When rewards expire', type: 'string', example: '2026-12-31', required: true, source: 'Guardian' },
            { key: 'expirationAmount', label: 'Expiration Amount', description: 'Amount expiring', type: 'number', example: '15.00', required: true, source: 'Guardian' },
            { key: 'redeemUrl', label: 'Redeem URL', description: 'Link to redeem rewards', type: 'string', example: 'https://pawtag.co.nz/account/guardian/rewards', required: true, source: 'System' },
          ],
        },
        {
          name: 'Purchase Points',
          slug: 'guardian-purchase-points',
          subject: 'You earned {{pointsEarned}} Guardian Points!',
          title: 'Points Earned!',
          subtitle: 'Thank you for your purchase',
          body: 'Hi {{customerName}},\n\nYou earned {{pointsEarned}} Guardian Points on your recent purchase (Order: {{orderNumber}}).\n\nTotal points: {{totalPoints}}\nTier: {{tier}}\n{{#pointsToNextTier}}Points to next tier: {{pointsToNextTier}}{{/pointsToNextTier}}',
          ctaText: 'View Dashboard',
          ctaUrl: '{{dashboardUrl}}',
          senderEmail: 'no-reply@pawtag.co.nz',
          senderName: 'PawTag',
          variables: ['customerName', 'orderNumber', 'pointsEarned', 'totalPoints', 'tier', 'pointsToNextTier', 'nextTier', 'isGoldMember', 'dashboardUrl'],
          status: 'active' as const,
          businessFlow: 'guardian_loyalty' as const,
          purpose: 'Post-purchase notification showing points earned.',
          triggerDescription: 'Sent after a purchase completes.',
          recipientDescription: 'Customer who made a purchase',
          emailType: 'transactional' as const,
          isCritical: false,
          version: 1,
          variableDefinitions: [
            { key: 'customerName', label: 'Customer Name', description: 'First name of the customer', type: 'string', example: 'John', required: true, source: 'Customer' },
            { key: 'orderNumber', label: 'Order Number', description: 'Order identifier', type: 'string', example: 'PT-10294', required: true, source: 'Order' },
            { key: 'pointsEarned', label: 'Points Earned', description: 'Points earned on purchase', type: 'number', example: '50', required: true, source: 'Guardian' },
            { key: 'totalPoints', label: 'Total Points', description: 'Total points balance', type: 'number', example: '300', required: true, source: 'Guardian' },
            { key: 'tier', label: 'Tier', description: 'Current Guardian tier', type: 'string', example: 'Nurture', required: true, source: 'Guardian' },
            { key: 'dashboardUrl', label: 'Dashboard URL', description: 'Link to Guardian dashboard', type: 'string', example: 'https://pawtag.co.nz/account/guardian', required: true, source: 'System' },
          ],
        },
        {
          ...
          slug: 'guardian-renewal-reminder',
          subject: 'Your Guardian Membership Renewal — PawTag',
          title: 'Membership Renewal',
          subtitle: 'Guardian benefits continue',
          body: 'Hi {{customerName}},\n\nYour {{tier}} Guardian membership will renew on {{renewalDate}}.\n\nCurrent benefits:\n{{#currentBenefits}}- {{currentBenefits}}\n{{/currentBenefits}}',
          ctaText: 'View Dashboard',
          ctaUrl: '{{dashboardUrl}}',
          senderEmail: 'no-reply@pawtag.co.nz',
          senderName: 'PawTag',
          variables: ['customerName', 'tier', 'renewalDate', 'currentBenefits', 'dashboardUrl'],
          status: 'active' as const,
          businessFlow: 'guardian_loyalty' as const,
          purpose: 'Reminds Guardian member about upcoming renewal.',
          triggerDescription: 'Sent before membership renewal.',
          recipientDescription: 'Guardian member approaching renewal',
          emailType: 'transactional' as const,
          isCritical: false,
          version: 1,
          variableDefinitions: [
            { key: 'customerName', label: 'Customer Name', description: 'First name of the customer', type: 'string', example: 'John', required: true, source: 'Customer' },
            { key: 'tier', label: 'Tier', description: 'Current Guardian tier', type: 'string', example: 'Nurture', required: true, source: 'Guardian' },
            { key: 'renewalDate', label: 'Renewal Date', description: 'When membership renews', type: 'string', example: '2026-12-31', required: true, source: 'Guardian' },
            { key: 'currentBenefits', label: 'Current Benefits', description: 'List of current benefits', type: 'array', example: '2x points, Priority support', required: true, source: 'Guardian' },
            { key: 'dashboardUrl', label: 'Dashboard URL', description: 'Link to Guardian dashboard', type: 'string', example: 'https://pawtag.co.nz/account/guardian', required: true, source: 'System' },
          ],
        },
        // ─── Refunds (missing from DB) ───
        {
          ...
          body: 'Hi {{name}},\n\nYour refund for order {{orderNumber}} has been initiated and is being processed.\n\nRefund ID: {{refundId}}\nAmount: {{currency}} {{amount}}\n{{#expectedArrival}}Expected arrival: {{expectedArrival}}{{/expectedArrival}}',
          ctaText: 'View Order',
          ctaUrl: '{{viewOrderUrl}}',
          senderEmail: 'no-reply@pawtag.co.nz',
          senderName: 'PawTag',
          variables: ['name', 'orderNumber', 'refundId', 'amount', 'currency', 'expectedArrival', 'viewOrderUrl'],
          status: 'active' as const,
          businessFlow: 'orders_commerce' as const,
          purpose: 'Informs customer that refund has been initiated.',
          triggerDescription: 'Sent when Stripe refund is created (status: pending).',
          recipientDescription: 'Customer whose order was refunded',
          emailType: 'transactional' as const,
          isCritical: false,
          version: 1,
          variableDefinitions: [
            { key: 'name', label: 'Customer Name', description: 'First name of the customer', type: 'string', example: 'John', required: true, source: 'Customer' },
            { key: 'orderNumber', label: 'Order Number', description: 'Order identifier', type: 'string', example: 'PT-10294', required: true, source: 'Order' },
            { key: 'refundId', label: 'Refund ID', description: 'Stripe refund identifier', type: 'string', example: 're_1234567890', required: true, source: 'Stripe' },
            { key: 'amount', label: 'Amount', description: 'Refund amount', type: 'number', example: '89.90', required: true, source: 'Refund' },
            { key: 'currency', label: 'Currency', description: 'Currency code', type: 'string', example: 'NZD', required: true, source: 'Refund' },
            { key: 'expectedArrival', label: 'Expected Arrival', description: 'When refund arrives', type: 'string', example: '5-10 business days', required: false, source: 'Stripe' },
            { key: 'viewOrderUrl', label: 'View Order URL', description: 'Link to view order', type: 'string', example: 'https://pawtag.co.nz/account/orders/123', required: true, source: 'System' },
          ],
        },
        {
          name: 'Refund Settled',
          slug: 'refund-settled',
          subject: 'Refund Settled — Order {{orderNumber}}',
          title: 'Refund Complete',
          subtitle: 'Your refund has been processed',
          body: 'Hi {{name}},\n\nYour refund for order {{orderNumber}} has been successfully processed.\n\nRefund ID: {{refundId}}\nAmount: {{currency}} {{amount}}\n{{#arn}}Bank Reference: {{arn}}{{/arn}}\nSettled: {{settledAt}}',
          ctaText: 'View Order',
          ctaUrl: '{{viewOrderUrl}}',
          senderEmail: 'no-reply@pawtag.co.nz',
          senderName: 'PawTag',
          variables: ['name', 'orderNumber', 'refundId', 'arn', 'amount', 'currency', 'settledAt', 'viewOrderUrl'],
          status: 'active' as const,
          businessFlow: 'orders_commerce' as const,
          purpose: 'Confirms refund has been successfully processed.',
          triggerDescription: 'Sent when Stripe refund is confirmed (status: succeeded).',
          recipientDescription: 'Customer whose refund was settled',
          emailType: 'transactional' as const,
          isCritical: false,
          version: 1,
          variableDefinitions: [
            ...
            { key: 'orderNumber', label: 'Order Number', description: 'Order identifier', type: 'string', example: 'PT-10294', required: true, source: 'Order' },
            { key: 'refundId', label: 'Refund ID', description: 'Stripe refund identifier', type: 'string', example: 're_1234567890', required: true, source: 'Stripe' },
            { key: 'arn', label: 'ARN', description: 'Acquirer Reference Number', type: 'string', example: 'ARN1234567890', required: false, source: 'Stripe' },
            { key: 'amount', label: 'Amount', description: 'Refund amount', type: 'number', example: '89.90', required: true, source: 'Refund' },
            { key: 'currency', label: 'Currency', description: 'Currency code', type: 'string', example: 'NZD', required: true, source: 'Refund' },
            { key: 'settledAt', label: 'Settled At', description: 'When refund was settled', type: 'string', example: '12 Sep 2026', required: true, source: 'Stripe' },
            { key: 'viewOrderUrl', label: 'View Order URL', description: 'Link to view order', type: 'string', example: 'https://pawtag.co.nz/account/orders/123', required: true, source: 'System' },
          ],
        },
        {
          ...
          title: 'Refund Update',
          subtitle: 'Refund status changed',
          body: 'Hi {{name}},\n\nThere\'s an update on your refund for order {{orderNumber}}.\n\nRefund ID: {{refundId}}\nAmount: {{currency}} {{amount}}\n{{#failureReason}}Reason: {{failureReason}}{{/failureReason}}\n{{#willRetry}}We\'ll automatically retry the refund.{{/willRetry}}',
          ctaText: 'View Order',
          ctaUrl: '{{viewOrderUrl}}',
          senderEmail: 'no-reply@pawtag.co.nz',
          senderName: 'PawTag',
          variables: ['name', 'orderNumber', 'refundId', 'amount', 'currency', 'failureReason', 'willRetry', 'viewOrderUrl'],
          status: 'active' as const,
          businessFlow: 'orders_commerce' as const,
          purpose: 'Notifies customer that refund failed and explains next steps.',
          triggerDescription: 'Sent when Stripe refund fails.',
          recipientDescription: 'Customer whose refund failed',
          emailType: 'transactional' as const,
          isCritical: false,
          version: 1,
          variableDefinitions: [
            ...
            { key: 'amount', label: 'Amount', description: 'Refund amount', type: 'number', example: '89.90', required: true, source: 'Refund' },
            { key: 'currency', label: 'Currency', description: 'Currency code', type: 'string', example: 'NZD', required: true, source: 'Refund' },
            { key: 'failureReason', label: 'Failure Reason', description: 'Why refund failed', type: 'string', example: 'Insufficient funds', required: false, source: 'Stripe' },
            { key: 'willRetry', label: 'Will Retry', description: 'Whether refund will be retried', type: 'boolean', example: 'true', required: false, source: 'System' },
            { key: 'viewOrderUrl', label: 'View Order URL', description: 'Link to view order', type: 'string', example: 'https://pawtag.co.nz/account/orders/123', required: true, source: 'System' },
          ],
        },
        // ─── Generic Notification ───
        {
          ...
          status: 'active' as const,
          businessFlow: 'admin_system' as const,
          purpose: 'Generic notification fallback for any notification type.',
          triggerDescription: 'Sent when a notification requires email delivery.',
          recipientDescription: 'User with notification preferences enabled',
          emailType: 'transactional' as const,
          isCritical: false,
          version: 1,
          variableDefinitions: [
            { key: 'title', label: 'Title', description: 'Notification title', type: 'string', example: 'New notification', required: true, source: 'System' },
            { key: 'message', label: 'Message', description: 'Notification message', type: 'string', example: 'You have a new notification', required: true, source: 'System' },
            { key: 'actionUrl', label: 'Action URL', description: 'Optional link to view details', type: 'string', example: 'https://pawtag.co.nz/account', required: false, source: 'System' },
          ],
        },
      ];
