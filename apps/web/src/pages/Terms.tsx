...
export default function Terms() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      />
      <h1 className="text-3xl font-bold mb-6">{page?.title || `Terms of Service - ${companyName}`}</h1>
      <div className="prose prose-gray max-w-none">
        {page?.sections?.filter(s => s.visible && s.status === 'published').map((section) => (
          ...
          <div className="text-gray-600 space-y-4">
            ...
            <p>By accessing or using {companyName}'s services, you agree to be bound by these Terms of Service.</p>
            <h2 className="text-xl font-semibold mt-6">2. Description of Service</h2>
            <p>{companyName} provides QR-coded pet recovery tags and associated online profiles to help reunite lost pets with their owners.</p>
            ...
            <p>{companyName} is not responsible for the recovery of lost pets. Our service facilitates communication between finders and owners but does not guarantee reunification.</p>
