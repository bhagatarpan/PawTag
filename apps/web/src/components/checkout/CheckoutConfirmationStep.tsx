...
import { CheckCircle, Mail, Home, FileText, Package, Truck, Clock, Check, Share2, Download, Printer, ExternalLink, Crown, PawPrint } from 'lucide-react';
  ...
  return (
    <div className="max-w-2xl mx-auto py-8 space-y-6">
      ...
      {confirmedItems.length > 0 && (
        <div style={{ animation: 'fade-in-up 0.4s ease-out 0.75s both' }}>
          <OrderSummaryCard
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6" style={{ animation: 'fade-in-up 0.4s ease-out 0.8s both' }}>
      ...
      {/* Invoice Section */}
      {confirmedInvoice && (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6" style={{ animation: 'fade-in-up 0.4s ease-out 0.85s both' }}>
