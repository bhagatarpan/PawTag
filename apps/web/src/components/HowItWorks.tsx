...
const steps = [
  {
    ...
    desc: 'Create a secure profile with your pet\'s name, photo, medical needs, and your contact details.',
  ...
  },
  {
    ...
    desc: 'Clip the durable QR tag onto your pet\'s collar. It\'s waterproof, scratch-resistant, and built to last.',
  ...
  },
  {
    ...
    desc: 'Anyone with a smartphone can scan the QR code — no app needed. They instantly see your pet\'s profile.',
  ...
  },
  {
    ...
    desc: 'The finder contacts you directly, and you get an instant notification with their location. Reunion in minutes.',
