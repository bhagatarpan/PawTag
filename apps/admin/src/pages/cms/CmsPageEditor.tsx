...
export default function CmsPageEditor() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Save Bar */}
      <div className="bg-white rounded-lg border border-gray-200 p-4 flex items-center justify-between sticky bottom-0">
        <p className="text-sm text-gray-500">{saving ? 'Saving...' : sections.length + ' sections'}</p>
